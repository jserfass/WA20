var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            description: "County: Snohomish<br>Land Management: Mount Baker-Snoqualmie National Forest<br>Summit Elevation: 6,850 feet<br>Prominence: 4,490 feet<br>Saddle: 2,360 feet<br><b>Standard Route:</b> Tin Can Gap (Winter)<br>Route YDS Rating: Class 3<br>Route NCCS Rating: Grade II<br>Mileage (Round Trip): 31.9<br>Elevation Gain: 6,903 feet<br> <a HREF='/pdf/threefingers.pdf' target=_blank style = 'color: white'> Route Elevation Profile</a><br>Route Animation: <a HREF='/RoutePreview/ThreeFingers.html' target=_blank style = 'color: white'> <b>Tin Can Gap (Winter)</b></a> ",
            location: {
